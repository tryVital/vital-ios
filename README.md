...
```swift
.package(url: "https://github.com/tryvital/vital-ios", from: "1.4.0-beta.1"),
```
...
```
pod "VitalCore", "~> 1.4.0-beta.1"
pod "VitalDevices", "~> 1.4.0-beta.1"
pod "VitalHealthKit", "~> 1.4.0-beta.1"
```
