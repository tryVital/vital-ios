...
```swift
.package(url: "https://github.com/tryvital/vital-ios", from: "1.9.0-beta.1"),
```
...
```
pod "VitalCore", "~> 1.9.0-beta.1"
pod "VitalDevices", "~> 1.9.0-beta.1"
pod "VitalHealthKit", "~> 1.9.0-beta.1"
```
