...
```swift
.package(url: "https://github.com/tryvital/vital-ios", from: "1.4.1-beta.2"),
```
...
```
pod "VitalCore", "~> 1.4.1-beta.2"
pod "VitalDevices", "~> 1.4.1-beta.2"
pod "VitalHealthKit", "~> 1.4.1-beta.2"
```
